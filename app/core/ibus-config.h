...
#ifndef GRACEFUL_IBUS_IBUS_CONFIG_H
#define GRACEFUL_IBUS_IBUS_CONFIG_H
...
#define IBUS_TYPE_CONFIG                (ibus_config_get_type ())
#define IBUS_CONFIG(obj)                (G_TYPE_CHECK_INSTANCE_CAST ((obj), IBUS_TYPE_CONFIG, IBusConfig))
#define IBUS_CONFIG_CLASS(klass)        (G_TYPE_CHECK_CLASS_CAST ((klass), IBUS_TYPE_CONFIG, IBusConfigClass))
#define IBUS_IS_CONFIG(obj)             (G_TYPE_CHECK_INSTANCE_TYPE ((obj), IBUS_TYPE_CONFIG))
#define IBUS_IS_CONFIG_CLASS(klass)     (G_TYPE_CHECK_CLASS_TYPE ((klass), IBUS_TYPE_CONFIG))
#define IBUS_CONFIG_GET_CLASS(obj)      (G_TYPE_INSTANCE_GET_CLASS ((obj), IBUS_TYPE_CONFIG, IBusConfigClass))
 ...
 */
IBusConfig* ibus_config_new (GDBusConnection* conn, GCancellable* cancel, GError** error);
 ...
 */
GVariant* ibus_config_get_value_async_finish (IBusConfig* config, GAsyncResult* res, GError** error);
...
#endif //GRACEFUL_IBUS_IBUS_CONFIG_H
