...
ibus_engine_class_init (IBusEngineClass *class)
{
    ...
    engine_signals[FOCUS_IN_ID] =
        g_signal_new (g_intern_static_string("focus-in-id"),
                      G_TYPE_FROM_CLASS (gobject_class),
                      G_SIGNAL_RUN_LAST,
    ...
    engine_signals[FOCUS_OUT_ID] =
        g_signal_new (g_intern_static_string("focus-out-id"),
                      G_TYPE_FROM_CLASS (gobject_class),
                      G_SIGNAL_RUN_LAST,
    ...
    engine_signals[RESET] =
        g_signal_new (g_intern_static_string("reset"),
                      G_TYPE_FROM_CLASS (gobject_class),
                      G_SIGNAL_RUN_LAST,
    ...
    engine_signals[ENABLE] =
        g_signal_new (g_intern_static_string("enable"),
                      G_TYPE_FROM_CLASS (gobject_class),
                      G_SIGNAL_RUN_LAST,
    ...
    engine_signals[DISABLE] =
        g_signal_new (g_intern_static_string("disable"),
                      G_TYPE_FROM_CLASS (gobject_class),
                      G_SIGNAL_RUN_LAST,
    ...
    engine_signals[SET_CAPABILITIES] =
        g_signal_new (g_intern_static_string("set-capabilities"),
                      G_TYPE_FROM_CLASS (gobject_class),
                      G_SIGNAL_RUN_LAST,
    ...
    engine_signals[PROCESS_HAND_WRITING_EVENT] =
        g_signal_new (g_intern_static_string("process-hand-writing-event"),
                      G_TYPE_FROM_CLASS (gobject_class),
                      G_SIGNAL_RUN_LAST,
    ...
    engine_signals[CANCEL_HAND_WRITING] =
        g_signal_new (g_intern_static_string("cancel-hand-writing"),
                      G_TYPE_FROM_CLASS (gobject_class),
                      G_SIGNAL_RUN_LAST,
    ...
    engine_signals[SET_SURROUNDING_TEXT] =
        g_signal_new (g_intern_static_string("set-surrounding-text"),
                      G_TYPE_FROM_CLASS (gobject_class),
                      G_SIGNAL_RUN_LAST,
